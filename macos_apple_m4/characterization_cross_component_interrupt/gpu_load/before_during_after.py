...
MONITOR_BIN = os.environ.get("ANE_POWER_MONITOR", str(SCRIPT_DIR / "external/ANEPowerMonitor"))
RESULTS_DIR = os.environ.get("INPU_CROSS_RESULTS_DIR", str(SCRIPT_DIR / "results_bda"))
PYTHON_BIN = os.environ.get("INPU_PYTHON", sys.executable)
WORKER_DIR = os.environ.get("INPU_CROSS_WORKER_DIR", str(SCRIPT_DIR))
