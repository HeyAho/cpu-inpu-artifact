...
将历史 M2 arm64 `ANEPowerMonitor` 复制到 M5 Pro，并使用完全相同的实验协议重新采集后：

| 监控器 | Black ANE Mean | White ANE Mean | Δ | Ratio | 5-fold CV |
|---|---:|---:|---:|---:|---:|
| M5 Pro 当前监控器 | 4.8075 ± 0.2188 | 9.0088 ± 0.4241 | 4.2013 | 1.874x | 100% |
| M2 旧版监控器 | 9.3601 ± 0.2363 | 17.6438 ± 0.4291 | 8.2837 | 1.885x | 100% |

旧版读数约为当前监控器的 1.95 倍，但黑/白比例几乎一致，进一步说明跨平台原始 `ANE` 数字主要受 IOReport 通道和监控器尺度影响。
...
- `m2_old_monitor/`：M2 旧监控器、60 个复测 CSV 和对应分类结果。
