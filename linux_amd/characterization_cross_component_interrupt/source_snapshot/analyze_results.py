...
def main():
    ...
    aggregate_rows = []
    report = {"protocol": "cross_platform_v2_same_model_family", "power_source": "Direct AMD gpu_metrics average_ipu_power"}
    ...
    fig.suptitle("AMD ResNet152 NPU response under aligned protocol", fontweight="bold")
    fig.tight_layout()
    fig.savefig(results_dir / "amd_resnet152_aligned_power_freq_irq_vs_load.png", dpi=200)
    fig.savefig(results_dir / "amd_resnet152_aligned_power_freq_irq_vs_load.pdf")
